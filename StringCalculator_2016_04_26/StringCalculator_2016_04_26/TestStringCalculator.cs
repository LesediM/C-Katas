...
namespace StringCalculator_2016_04_26
{
    ...
    public class TestStringCalculator
    {
        ...
        [Test]
        public void Add_GivenOneNumberString_ShouldReturnSum()
        {
            //---------------Set up test pack-------------------
            var expected = 1;
            var numbers = "1";
        ...
        [Test]
        public void Add_GivenTwoNegativeNumberString_ShouldReturnSum()
        {
            //---------------Set up test pack-------------------
        ...
        [Test]
        public void Add_GivenGreaterthan1000NumberString_ShouldReturnSum()
        {
            //---------------Set up test pack-------------------
            var expected = 2;
            var numbers = "1001,2";
