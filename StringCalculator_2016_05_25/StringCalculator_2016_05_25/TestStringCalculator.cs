...
namespace StringCalculator_2016_05_25
{
    ...
    public class TestStringCalculator
    {
        ...
        [Test]
        public void Add_GivenNumAbove1000InNumberString_ShouldReturnSumAndIgnoreNumAbove1000()
        {
            //---------------Set up test pack-------------------
            var numbers = "1001,2";
            var expected = 2;
        ...
        [Test]
        public void Add_GivenManyAndLongDelimiterInNumberString_ShouldReturnSum()
        {
            //---------------Set up test pack-------------------
            var numbers = "//[*][%][$$$]\n1*2%3$$$4";
            var expected = 10;
