...
namespace StringCalculator_2016_06_03
{
    ...
    public class TestStringCalculator
    {
        ...
        [Test]
        public void Add_GivenNegaetiveInNumberString_ShouldReturnException()
        {
            //---------------Set up test pack-------------------
            var numbers = "1,-2";
        ...
        [Test]
        public void Add_GivenManyNegaetiveInNumberString_ShouldReturnException()
        {
            //---------------Set up test pack-------------------
            var numbers = "1,-2,-3";
        ...
        [Test]
        public void Add_GivenNumAbove1000InNumberString_ShouldReturnSumIgnoreNumAbove1000()
        {
            //---------------Set up test pack-------------------
            var numbers = "1001,2";
            var expected = 2;
