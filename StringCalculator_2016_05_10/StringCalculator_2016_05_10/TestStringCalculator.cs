...
namespace StringCalculator_2016_05_10
{
    ...
    public class TestStringCalculator
    {
        ...
        [Test]
        public void Add_GivenNumberStringWithLongDelimiter_ShouldReturnSumBut()
        {
            //---------------Set up test pack-------------------
            var numbers = "//[***]\n1***2***3";
            var expected = 6;
        ...
        [Test]
        public void Add_GivenNumberStringWithManyDelimiter_ShouldReturnSumBut()
        {
            //---------------Set up test pack-------------------
            var numbers = "//[*][%]\n1*2%3";
            var expected = 6;
        ...
        [Test]
        public void Add_GivenNumberStringWithManyAndLongDelimiter_ShouldReturnSumBut()
        {
            //---------------Set up test pack-------------------
            var numbers = "//[*][%][$$$]\n1*2%3$$$4";
            var expected = 10;
