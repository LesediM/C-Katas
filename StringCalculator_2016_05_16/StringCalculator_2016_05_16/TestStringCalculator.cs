...
namespace StringCalculator_2016_05_16
{
    ...
    public class TestStringCalculator
    {
        ...
        [Test]
        public void Add_GivenSingleNumberString_ShouldReturnThat()
        {
            //---------------Set up test pack-------------------
            var numbers = "1";
            var expected = 1;
        ...
        public void Add_GivenNegativeNumberString_ShouldReturnThrowException()
        {
            //---------------Set up test pack-------------------
            var numbers = "1,2,-3";
            var expected = "negative numbers not allowed: -3";
            var stringCalculator = CreateStringCalculator();
            //---------------Assert Precondition----------------
        ...
        [Test]
        public void Add_GivenTwoNegativeNumberString_ShouldReturnThrowException()
        {
            //---------------Set up test pack-------------------
            var numbers = "1,-2,-3";
        ...
        public void Add_GivenManyNegativeNumberString_ShouldReturnThrowException()
        {
            //---------------Set up test pack-------------------
            var numbers = "-1,-2,-3";
            var expected = "negative numbers not allowed: -1,-2,-3";
            var stringCalculator = CreateStringCalculator();
            //---------------Assert Precondition----------------
        ...
        [Test]
        public void Add_GivenAbove1000NumberString_ShouldReturnSumButIgnoreNumAbove1000()
        {
            //---------------Set up test pack-------------------
            var numbers = "1001,2";
            var expected = 2;
        ...
        [Test]
        public void Add_GivenNewLongDelimiterNumberString_ShouldReturnSum()
        {
            //---------------Set up test pack-------------------
            var numbers = "//[***]\n1***2***3";
            var expected = 6;
        ...
        [Test]
        public void Add_GivenNewManyDelimiterNumberString_ShouldReturnSum()
        {
            //---------------Set up test pack-------------------
            var numbers = "//[*][%]\n1*2%3";
            var expected = 6;
        ...
        [Test]
        public void Add_GivenNewManyAndOneLongDelimiterNumberString_ShouldReturnSum()
        {
            //---------------Set up test pack-------------------
            var numbers = "//[*][%][$$$]\n1*2%3$$$4";
            var expected = 10;
