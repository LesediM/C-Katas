...
namespace StringCalculator_2016_05_23
{
    ...
    public class TestStringCalculator
    {
        ...
        [Test]
        public void Add_GivenNegativeNumberString_ShouldReturnException()
        {
            //---------------Set up test pack-------------------
            var numbers = "1,-2";
        ...
        [Test]
        public void Add_GivenManyNegativeNumberString_ShouldReturnException()
        {
            //---------------Set up test pack-------------------
            var numbers = "-1,-2";
        ...
        [Test]
        public void Add_GivenNumAbove1000NumberString_ShouldReturnSumButIgnoreNumAbove1000()
        {
            //---------------Set up test pack-------------------
            var numbers = "1001,2";
            var expected = 2;
        ...
        [Test]
        public void Add_GivenManyAndLongDelimiterNumberString_ShouldReturnSum()
        {
            //---------------Set up test pack-------------------
            var numbers = "//[*][%][$$$]\n1*2%3$$$4";
            var expected = 10;
